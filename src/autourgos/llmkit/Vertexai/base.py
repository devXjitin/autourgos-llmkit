...
def _build_url(
    ...
    Allows targeting a specific endpoint ID (default: "openapi" for unified API).

    Examples:
        Global:
            https://aiplatform.googleapis.com/v1beta1/projects/{pid}/locations/global/endpoints/openapi/chat/completions
        Custom Endpoint:
            https://{region}-aiplatform.googleapis.com/v1beta1/projects/{pid}/locations/{region}/endpoints/{endpoint_id}/chat/completions
    """
    base = f"https://{endpoint}/v1beta1/projects/{project_id}/locations/{region}/endpoints/{endpoint_id}/chat/completions"
    return base
...
def vertexai_llm(
    ...
    *,
    ...
    url = _build_url(endpoint, project_id, region, endpoint_id)
